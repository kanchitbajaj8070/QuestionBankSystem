...
public class questionsController implements Initializable {
    ...
    @Override
    public void initialize(URL arg0, ResourceBundle arg1) { //resizeFuntionality();
    ...
    public void viewRowFromQuestionTable() {
        ...
        try {
            ...
            FXMLLoader viewQuestionLoader = new FXMLLoader(
                    getClass().getResource("/fxmls/viewDetialsQuestions.fxml"));
    ...
    public void loadAddQuestionWindow() throws Exception {
        ...
        Parent root = addQuestionLoader.load(getClass().getResource("/fxmls/addQuestion.fxml"));
    ...
    public void handleEditQuestionButton() {
        ...
        if (questionsTable.getSelectionModel().getSelectedItems().size() == 0) {
            ...
            FXMLLoader editQuestionLoader = new FXMLLoader(
                    getClass().getResource("/fxmls/editQuestion.fxml"));
            Parent root = null;
            try {

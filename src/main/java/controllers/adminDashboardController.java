...
homeLoader=new FXMLLoader(getClass().getResource("/fxmls/qbitHome.fxml"));
	...
	{	anchorPaneMain.setPrefWidth(borderPane.getWidth());
         categoryLoader =new FXMLLoader(getClass().getResource("/fxmls/qbitCategory.fxml"));
	...
	{	anchorPaneMain.setPrefWidth(borderPane.getWidth());
	   usersLoader= new FXMLLoader(getClass().getResource("/fxmls/qbitUsers.fxml"));
		anchorPaneMain=usersLoader.load();
	   borderPane.setCenter(anchorPaneMain);
	}	public void handleQuestionsButtonAction() throws Exception
	{	anchorPaneMain.setPrefWidth(borderPane.getWidth());
          questionsloader=new FXMLLoader((getClass().getResource("/fxmls/qbitQuestions.fxml")));
	...
	public void handlePaperMakerButtonAction() 
	{
		try {
			anchorPaneMain.setPrefWidth(borderPane.getWidth());
		papersLoader=new FXMLLoader(getClass().getResource("/fxmls/qbitPapers.fxml"));

...
public class usersController implements Initializable {
    ...
    private ObservableList<usersModel> usersData = FXCollections.observableArrayList();

    public ObservableList<usersModel> getPersonData() {
        return usersData;
    }
    ...
    public void deleteRowFromUsersTable() {
        ...
        if (rowToDelete != null) {
            ...
            try {
                ...
                if (res == 1) {
                    Platform.runLater(() -> {
                        tableViewUsers.getItems().removeAll(rowToDelete);
                    });
    ...
    public void handleAddUserButtonAction() throws Exception {
        ...
        Parent root = FXMLLoader.load(getClass().getResource("/fxmls/addUser.fxml"));
